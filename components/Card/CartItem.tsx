...
export default function CartItemCard(props: shoppingCartItemProps) {
  ...
  const { id, title, image, authors, type, price, averageRating, quantity, stock } =
    props;
  ...
  return (
    ...
    >
      <CardMedia sx={{ display: "flex" }}>
        <Image
          src={image}//`https://picsum.photos/seed/${id}/200/300`}
          alt={title}
          width={150}
          height={225}
        />
